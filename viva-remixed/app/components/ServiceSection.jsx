        ...
        >
            <Tab.List className="relative z-10 order-last col-span-6 space-y-6">
                {features.map((feature, featureIndex) => (
                    <div
                        key={feature.name}
                        className="relative rounded-2xl transition-colors hover:bg-neutral-950/10"
                    >
                        ...
                        <div className="relative z-10 p-8">
                            ...
                            <h3 className="mt-6 text-lg font-semibold text-cosaWhite">
    ...
    return (
        <>         
            <div className="relative mt-24 sm:mt-32 lg:mt-40">
                <SectionIntro
                    id="features"
                    aria-label="Onlince services for investing all your money"
                    eyebrow="What we do"
