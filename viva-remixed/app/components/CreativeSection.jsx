        ...
        <Section title="Discover" image={{ src: imageScarf }}>
            <div className="space-y-6 text-base text-neutral-600">
                <p>
                    ...
                    and goals. We immerse ourselves in their day-to-day
                    operations to grasp the essence of their business
                </p>
                <p>
                    Our team of private investigators shadow the company
                    directors for several weeks, while our account managers
                    focus on examinining their discarded materials.
                    Subsequently, our senior security experts employ social
                    engineering hacks to gain access to their{' '}
                    <strong className="font-semibold text-neutral-950">
                        business
                    </strong>{' '}
                    accounts, providing that information to our forensic
                    accounting team.
                </p>
                <p>
            ...
            <Container className="mt-24">
                <GridList>
                    <GridListItem title="Remove ambiguity">
                        The first step in establishing a partnership is to have
                        our designer incorporate your logo into our template.
                    </GridListItem>
                    <GridListItem title="360° view">
                        We take pride in our ability to always meet deadlines,
                        which is made easy by the fact that most of the work was
                        completed years ago
                    </GridListItem>
                    <GridListItem title="Grounded in data">
                        We prioritize transparency in all of our processes,
                        acknowledging the reality that our clients rarely read
                        any content.
                    </GridListItem>
                    <GridListItem title="Consistent digital experience">
                        Every business has unique needs, and our greatest
                        challenge is accommodating those needs within our
                        existing framework
                    </GridListItem>
                    ...
                    <GridListItem title="Solving common problems">
                        The technological landscape is constantly evolving, and
                        we are too. We are always searching for new open-source
...
export default function CreativeSection() {
    return (
        <>
            ...
            >
                <p>
                    At Viva Web Design, we take the time to understand the
                    business goals and user needs before finding creative
                    solutions to address them. Our creative process:{' '}
                    <strong className="font-semibold text-neutral-950">
                        Discover
                    </strong>
                    ,{' '}
