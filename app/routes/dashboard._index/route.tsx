...
import { Link, useLoaderData, type ShouldRevalidateFunctionArgs } from "@remix-run/react";
 ...
 export default function Index() {
    ...
    return (
        <PageIntro
            ...
            centered={true}
        >
            <Link to="/login" className="inline-flex px-4 py-1.5 text-sm font-semibold text-neutral-950">
...
export function LogButton() {
    ...
    return (
        ...
        <FadeIn>
        {userId ? (
            <div className="mb-6 mx-auto max-w-7xl flex justify-end">
