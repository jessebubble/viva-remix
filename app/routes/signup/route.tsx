...
function SignUpForm() {
   ...
   return (
     <FadeIn>
      ...
      <p className="mt-2 md:text-center text-neutral-500">
       ...
       <Form method="post">
         ...
         <Button type="submit">Create account</Button>
           ...
           <p className="mt-2 text-sm text-neutral-500">
             Not an employee?{' '}
             <Link to="/jobs" className="font-semibold leading-6 text-spursPink hover:text-spursTurq">
...
export default function Signup() {
   return (
      <div className="mt-24 sm:mt-32 lg:mt-40">
        ...
        >
          <p>
            <strong>Sign up</strong> for an account to view your employee dashboard
            <span className="block mt-2 text-sm">
              Have an exisiting account?{' '}
              <Link to="/login" className="font-semibold leading-6 text-spursPink hover:text-spursTurq">
                Log in &rarr;
              </Link>
            </span>
          </p>
