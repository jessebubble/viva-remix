                ...
                <div className="relative isolate overflow-hidden bg-slate-900/10 py-20 px-6 sm:py-24 sm:px-10 lg:py-24 xl:px-24">
                    ...
                    <div className="mx-auto mt-16 max-w-7xl px-1 sm:mt-20 md:mt-0 lg:mt-10 lg:px-8 lg:row-start-3">
                        <Tab.Group as="dl" className="text-base leading-7" >
                            <Tab.List className="flex items-center justify-evenly space-x-1 border-b border-gray-600 pb-3">
                                {toolsArray.map((tab) => (
                                    <Tab key={tab.name} className="text-left lg:text-center px-2 text-sm md:text-lg font-medium ui-selected:text-logopink ui-not-selected:text-gray-400" >
                                        {tab.name}
                                    </Tab>
                                ))}
                            </Tab.List>
