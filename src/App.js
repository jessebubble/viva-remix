            ...
            <div className="mx-auto md:max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-evenly lg:py-16 lg:px-8">
                ...
                <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div className="inline-flex rounded-md shadow">
                        <a href="/contact" className="inline-flex items-center justify-center rounded-md border border-transparent bg-rose-500 px-5 py-3 text-base font-medium text-white hover:bg-slate-700">Get started</a>
                    </div>
            ...
            <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                    <div className="lg:col-span-1">
                        ...
                        <span className='block text-indigo-500 text-lg md:text-xl'>Your idea brought to life</span>
                    </div>
                    <dl className="mt-10 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 sm:space-y-0 lg:col-span-2 lg:mt-0">
                        ...
                        <div>
                            ...
                            <dd className="mt-2 text-base text-gray-500">
                                 Our design tools give our developers the creative platform to challenge themselves, experiment and continue to learn new design techniques.
                            </dd>
                        </div>
                        <div>
                            <dt>
                            ...
                            <dd className="mt-2 text-base text-gray-500">
                                Headless gives us the creative freedom to design and the content management system opens the door for you to manage your content, your way.
                            </dd>
                        </div>
                    </dl>
                </div>
                ...
                <div className="lg:grid lg:grid-cols-12">
                    ...
                    <div className="relative bg-slate-900 lg:col-span-10 lg:col-start-3 lg:row-start-1 lg:grid lg:grid-cols-10 lg:items-center lg:rounded-3xl">
                        ...
                        <div className="relative mx-auto max-w-md space-y-6 py-12 px-4 sm:max-w-3xl sm:py-16 sm:px-6 lg:col-span-6 lg:col-start-4 lg:max-w-none lg:p-0">
                            ...
                            <a href="/contact" className="block w-full rounded-md border border-transparent bg-white py-3 px-5 text-center text-base font-medium text-cyan-500 shadow-md hover:bg-gray-50 sm:inline-block sm:w-auto">
                                Get VIVA+ 
                            </a>
                        </div>
                    </div>
