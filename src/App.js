        ...
        <main className="bg-slate-100">
            <div className="mx-auto md:max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-evenly lg:py-16 lg:px-8">
                <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    ...
                    <span className="block text-cyan-500">Someone Out there needs it</span>
                </h2>
                <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div className="inline-flex rounded-md shadow">
                        <a href="/contact" className="inline-flex items-center justify-center rounded-md border border-transparent bg-cyan-500 px-5 py-3 text-base font-medium text-white hover:bg-slate-700">Get started</a>
                    </div>
            ...
            <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                    <div className="lg:col-span-1">
                        ...
                        <span className='block text-cyan-500 text-lg md:text-xl'>Your idea brought to life</span>
                    </div>
