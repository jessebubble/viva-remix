...
export default function App() {
  return (
    ...
    <div className="w-full flex flex-col" >
          <h1 className='md:text-9xl font-black text-center subpixel-antialiased pb-3'> 
            <Link to="/"> VIVA WEB DESIGN </Link>
          </h1>
    </div>
    <div className="flex flex-col border-2 sticky top-0 border-black border-l-transparent bg-gradient-to-l from-indigo-500 via-purple-500 to-pink-500">
      <nav className='md:text-lg md:grid md:grid-cols-6 gap-4 px-4 py-4 text-center'>
        ...
        <ul className='hover:text-orange-400'> <Link to="/pricing"> Pricing </Link> </ul>
        <ul className='hover:text-purple-100'> <Link to="/contact"> Contact </Link> </ul>
        <ul className='hover:text-purple-100'> <Link to="/design"> Design </Link> </ul>
        <ul className='hover:text-rose-600 '> <Link to="/remote"> Remote </Link> </ul>
        <ul className='hover:text-rose-600'> <Link to="/about"> About </Link> </ul>
      </nav>
    </div>
    <div className="grid grid-cols-2 border-2 border-black">
        <main className="bg-yellow-300 px-4 py-60">
            <h1 className="text-2xl text-center md:text-4xl">Build Online Presence</h1>
        </main>
        <aside className="bg-pink-400 px-5 py-60">
            <h1 className="text-2xl text-center md:text-4xl">Responsive Web Design</h1>
        </aside>
    </div>
    <div className="grid grid-cols-1 border-2 border-black">
        <main className="bg-black px-4 py-10">
            <h1 className="text-2xl text-white text-center md:text-4xl">Text Scrolling </h1>
        </main>
    </div>
    <div className="grid grid-cols-1 border-2 border-black">
