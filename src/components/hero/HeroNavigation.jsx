            ...
            <nav className="flex items-center justify-between" aria-label="Global">
                <div className="flex lg:flex-1">
                    <Link to="/" className="-m-1.5 p-1.5">
                        ...
                        <img className="max-h-80 md:max-h-60 lg:max-h-40 w-full object-contain object-left" src={logoDark} alt="Viva Web Design" />
                    </Link>
                </div>
            ...
            <Dialog as="div" open={mobileMenuOpen} onClose={setMobileMenuOpen}>
                <Dialog.Panel focus="true" className="fixed inset-0 z-10 overflow-y-auto bg-white px-6 py-6 lg:hidden">
                    <div className="flex items-center justify-between">
                        <Link to="/" className="-m-1.5 p-1.5">
                            <span className="sr-only">Viva Web Design</span>
                            <img className="max-h-80 md:max-h-60 lg:max-h-40 w-full object-contain object-left" src={logoLight} alt="Viva Web Design" />
                        </Link>
                        <button
                            type="button"
