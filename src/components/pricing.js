...
export default function Pricing() {
    return (
        ...
        <main className="overflow-hidden bg-gray-50 lg:pb-3">
            <div className="relative mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8">
                <svg className="absolute top-0 left-full -translate-x-1/2 -translate-y-3/4 transform lg:left-auto lg:right-full lg:translate-x-2/3 lg:translate-y-1/4" width="404" height="784" fill="none" viewBox="0 0 404 784" aria-hidden="true">
                    <defs>
                        ...
                        <rect x="0" y="0" width="4" height="4" className="text-lime-300" fill="currentColor" />
                        </pattern>
                    </defs>
                ...
                <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                    <div className="lg:col-span-1">
                        ...
                        <span className='block text-lime-500 text-lg md:text-xl'>Your idea brought to life</span>
                    </div>
                    <dl className="mt-10 space-y-10 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 sm:space-y-0 lg:col-span-2 lg:mt-0">
                        <div>
                            <dt>
                                <div className="flex h-12 w-12 items-center justify-center rounded-md bg-lime-500 text-white">
                                    {/* <!-- Heroicon mobile --> */}
        ...
        <main className="relative bg-slate-900">
            ...
            <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-flow-col-dense xl:grid-cols-2 xl:gap-x-8">
                <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                    <h2 className="text-base font-semibold text-lime-400">
                        VIVA Web Design
                    </h2>
        ...
        <main className="bg-slate-900">
            <div className="mx-auto md:max-w-7xl py-12 px-4 sm:px-6 lg:flex lg:items-center lg:justify-between lg:py-16 lg:px-8">
                <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white sm:text-4xl">
                    ...
                    <span className="block text-lime-400">Someone Out there needs it</span>
                </h2>
                <div className="mt-8 flex lg:mt-0 lg:flex-shrink-0">
                    <div className="inline-flex rounded-md shadow">
                        <a href="/contact" className="inline-flex items-center justify-center rounded-md border border-transparent bg-lime-400 px-5 py-3 text-base font-medium text-white hover:bg-slate-700">Get started</a>
                    </div>
