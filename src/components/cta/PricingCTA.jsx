export default function PricingCTA() {
    ...
    return (
        ...
        <div className="bg-white pt-24 pb-16 sm:pt-32 sm:pb-24 xl:pb-32">
            <div className="bg-slate-900 pb-20 sm:pb-24 lg:pb-0">
                <div className="mx-auto flex max-w-7xl flex-col items-center gap-y-10 gap-x-8 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
                    <div className="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
                        <div className="relative aspect-[3/4] lg:aspect-[2/3] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
                            <img
                            className="absolute inset-0 h-full w-full rounded-2xl bg-slate-800 object-cover shadow-2xl"
                            src="https://cdn.sanity.io/images/etrj839y/production/59d18780a7e2fe3da64b1131a478d0b9a93f5731-512x512.png"
                            alt="web developer"
                            />
                        </div>
                    </div>
                    <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
                        <figure className="relative isolate pt-6 sm:pt-12">
                            ...
                            <figcaption className="mt-8 text-base">
                                <div className="font-semibold text-white">Jesse Hernandez</div>
                                <div className="mt-1 text-gray-400">@vivawebdesign</div>
                            </figcaption>
                        </figure>
                    </div>
                </div>
