...
export default function PageNotFoundCTA() {
    return (
                ...
                <div className="relative isolate overflow-hidden bg-slate-900 px-6 pt-16 shadow-2xl sm:rounded-3xl sm:px-16 md:pt-24 lg:flex lg:gap-x-20 lg:px-24 lg:pt-0">
                    ...
                    <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-300">
                            Click the button below to get back to our home page or learn more about our services.
                        </p>
                    ...
                    <div className="relative mt-16 h-80 lg:mt-8">
                        <Player
                            src="https://assets7.lottiefiles.com/packages/lf20_TBb4vlYKUL.json"
