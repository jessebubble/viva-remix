            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl space-y-16 divide-y divide-gray-100 lg:mx-0 lg:max-w-none">
                    <div className="grid grid-cols-1 gap-y-10 gap-x-8 lg:grid-cols-3">
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 lg:gap-8 order-2 lg:order-1">
                        ...
                        <div className='order-1 lg:order-2'>
                            <h2 className="text-3xl font-bold tracking-tight text-gray-900 text-center lg:text-right">Let's Connect</h2>
                            <p className="mt-4 leading-7 text-gray-600 text-center lg:text-right">
                                Ask us a question, schedule a meetup, request a service or just say hello. We love to hear from our community.
                            </p>
                            <dl className="">
                                <div className="mt-4">
                                    <dt className="sr-only">Social</dt>
                                    <dd className="flex items-center justify-center lg:justify-end space-x-3">
